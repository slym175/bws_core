...
/***/ "./core/resources/assets/js/scripts.bundle.js":
/*!****************************************************!*\
  !*** ./core/resources/assets/js/scripts.bundle.js ***!
  \****************************************************/
/***/ ((module) => {
...
},  true && void 0 !== module.exports && (module.exports = KTBlockUI);
var KTCookie = {
  get: function get(e) {
    ...
    var i = {
      ...
      a = function a(e) {
        ...
        if (null !== r && KTUtil.css(n.element, "right", r), null !== l) {
          ...
          if (g && g.length > 0) for (var v = 0, T = g.length; v < T; v++) {
...
}, "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTSwapper.init) : KTSwapper.init(),  true && void 0 !== module.exports && (module.exports = KTSwapper);
...
KTUtil.onDOMContentLoaded(function () {
  KTThemeMode.init();
}),  true && void 0 !== module.exports && (module.exports = KTThemeMode);
...
/******/ 	var __webpack_exports__ = __webpack_require__("./core/resources/assets/js/scripts.bundle.js");
/******/ 	
/******/ })()
;