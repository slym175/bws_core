...
class MakeRepositoryInterfaceCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $argumentName = 'repository_interface';
    ...
    {
        return [
            ['repository_interface', InputArgument::REQUIRED, 'The name of repository interface will be created.'],
    ...
    {
        return Str::studly($this->argument('repository_interface'));
    }
