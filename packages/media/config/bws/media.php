...
return [
    ...
    'libraries' => [
        'stylesheets' => [
            'vendor/bws/media/libraries/jquery-context-menu/jquery.contextMenu.min.css',
            'vendor/bws/media/css/media.css?v=' . time(),
        ],
        'javascript' => [
            'vendor/bws/media/libraries/bootstrap/js/bootstrap.bundle.js',
            'vendor/bws/media/libraries/lodash/lodash.min.js',
            'vendor/bws/media/libraries/clipboard/clipboard.min.js',
            'vendor/bws/media/libraries/dropzone/dropzone.js',
            'vendor/bws/media/libraries/jquery-context-menu/jquery.ui.position.min.js',
            'vendor/bws/media/libraries/jquery-context-menu/jquery.contextMenu.min.js',
            'vendor/bws/media/js/media.js?v=' . time(),
        ],
    ],
    ...
    'default_image' => env('RV_MEDIA_DEFAULT_IMAGE', '/vendor/bws/media/images/placeholder.png'),
