...
class MediaFile extends BaseModel
{
    ...
    public function getTypeAttribute(): string
    {
        ...
        foreach (bws_media()->getConfig('mime_types', []) as $key => $value) {
    ...
    {
        return bws_media()->humanFilesize($this->attributes['size']);
    }
    ...
    {
        return bws_media()->canGenerateThumbnails($this->mime_type);
    }
}
