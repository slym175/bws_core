...
namespace Bws\Media\Services\Cache;
...
class Cache implements CacheInterface
{
    ...
    {
        if (file_exists($this->config['stored_keys'])) {
            $cacheKeys = bws_helper()->getFileData($this->config['stored_keys']);
        ...
        bws_helper()->saveFileData($this->config['stored_keys'], $cacheKeys, true);
    ...
    public function flush()
    {
        ...
        if (!empty($cacheKeys)) {
            bws_helper()->getFileData($this->config['stored_keys'], $cacheKeys);
        } else {
